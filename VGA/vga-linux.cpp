...
void SDLVga::shutdown()
{
	SDL_Quit();
}


void SDLVga::setPixel(int x, int y, int value)
{
	value &=0xff;
	unsigned int r,g,b;
	int i,j;
...
int SDLVga::getPixel(int x, int y) const
{
	int i,j;
	Uint32 *pixels = (Uint32 *)screen->pixels;
	i=x*5;
